							...
							<div class="span12">
								<h4 class="title">
									...
									<span class="pull-right">
										<#--
										<a class="left button" href="<@s.url value="${templatePath}" />/#myCarousel-2" data-slide="prev"></a>
										<a class="right button" href="<@s.url value="${templatePath}" />/#myCarousel-2" data-slide="next"></a>
										-->
									</span>
								</h4>
								<ul class="thumbnails">
